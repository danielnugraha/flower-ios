...
class ParameterConverter {
    ...
    func dataToMultiArray(data: Data) -> MLMultiArray? {
    ...
    func multiArrayToData(multiArray: MLMultiArray) -> Data? {
    ...
    func dataToArray(data: Data) -> [Float]? {
        if let numpy = dataToNumpy(data: data) {
    ...
    func arrayToData(array: [Float], shape: [Int16]) -> Data? {
